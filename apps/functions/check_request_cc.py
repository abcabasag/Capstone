...
layout = html.Div(
    [
        ...
        html.H2('Citizen Charter Request Status Viewer'), # Page Header
        html.Hr(),
        dbc.Card( # Card Container
            [
                dbc.CardHeader( # Define Card Header
                    [
                        html.H3('Find Citizen Charter Requests')
                    ]
                ),
                                        ...
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    dbc.Input(
                                                        type='text',
                                                        id='cc_checkrequestfilter',
                                                        placeholder='Type your Request Number here.'
                                                    ),
                                                    width=5
                                                ),
                                                dbc.Col(
                                                    dbc.Button("Search", id="ccsearch_button", color="primary"),
                                                    width=1,
                                                ),
                                            ],
                                            className = 'mb-3'
...
@app.callback(
    Output('cc_checkrequestlist', 'children'),
    [Input('ccsearch_button', 'n_clicks')],
    [State('cc_checkrequestfilter', 'value')],
)
